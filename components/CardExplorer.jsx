    ...
    >
      ...
      <header style={{
        ...
        <form onSubmit={doSearch} style={{ display: "flex", gap: 8, alignItems: "center" }}>
          ...
          />
          <div style={{ display: "flex", borderRadius: 6, overflow: "hidden", border: "0.5px solid rgba(201,185,154,0.2)", flexShrink: 0 }}>
          ...
          <button type="button" onClick={doRandom} disabled={isLoading} style={{
